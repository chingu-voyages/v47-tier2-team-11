...
const Activity = ({ storedData, handleSetData, activityData, category, datesAndDays, handleShowActivityDeleteModal, handleActivityEdit }) => {
  ...
  const [newActivityName, setNewActivityName] = useState(activityData.activityName);
  ...
  const handleTaskDelete = (task) => {
    ...
    const updatedTasks = activityData.tasks.filter(storedTask => storedTask.id !== selectedTask.id);
        ...
        <tr>
          ...
          >
            ...
            <button
              ...
              title="Edit Activity"
              onClick={isEditing ? handleSaveActivityName : () => setIsEditing(true)}
            >
